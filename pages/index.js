...
/* component */
import HairTab from '@components/apparance-tabs/hair-tab'
import FaceTab from '@components/apparance-tabs/face-tab'
import SkinTab from '@components/apparance-tabs/skin-tab'
import EarsTab from '@components/apparance-tabs/ears-tab'
import MixDyeHairTab from '@components/apparance-tabs/mix-dye-hair-tab'
import MixDyeFaceTab from '@components/apparance-tabs/mix-dye-face-tab'
import HatTab from '@components/apparance-tabs/hat-tab'
import OverallTab from '@components/apparance-tabs/overall-tab'
